...
const quizInfo = {
  gcpDevOps: {
    ...
    desc: "SRE、CI/CD、Cloud Build、Cloud Deploy、Cloud Operations、GKE、信頼性、インシデント対応"
  },
  dynatraceAssociate: {
    title: "Dynatrace Associate Certification",
    desc: "OneAgent、Smartscape、Davis AI、Problems、Dashboards、Synthetic、Logs、Kubernetes監視"
  },
  newRelicFsop: {
    title: "New Relic Full-Stack Observability Practitioner",
    desc: "APM、Infrastructure、Logs、Browser、Mobile、NRQL、Alerts、ダッシュボード、分散トレーシング"
  }
};
...
if (type === "all") {
  document.title = "Cloud DevOps・Observability資格クイズ";
  pageTitle.textContent = "Cloud DevOps・Observability資格クイズ";
  pageDesc.textContent = "3カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.gcpDevOps;
